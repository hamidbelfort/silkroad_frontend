    ...
    <section className="relative h-[75vh] flex items-center justify-center bg-black text-white overflow-hidden">
      ...
      <AnimatedSection delay={0.1}>
        <div className="relative z-10 text-center max-w-2xl px-4">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-4 bg-gradient-to-b from-yellow-400 to-white text-transparent bg-clip-text drop-shadow-md">
            Welcome to {appTitle}
          </h1>
          <p className="text-lg md:text-xl text-neutral-200 mb-6 text-shadow-2xs">
            Your gateway to smart tourism and trusted services.
          </p>
